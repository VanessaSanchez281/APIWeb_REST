// Para indicar la dirección de la URL donde está la Web API.
// NOTA: El número de puerto es randomico y por lo tanto diferente
// para cada computadora por lo tanto es necesario adaptarlo a
// cada computadora. Para esto ejecute la aplicación y copie
// la url.
var api = "http://localhost:8080/CategoryService/webresources/rest.categories/";
...
function buscarCategoria(href) {
    ...
    // Llamar al metodo con el prefijo "Get" de la Web API que pasa como parametro el atributo "href".
